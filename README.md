# Задача работа с директориями:
 ...
 10. Расширение раздела (P.s - скриншот 10-2 ошибочный я при работе с `fdisk` ввёл в `last sector +5G` это решение оказалось не верное потом я просто тапнул `enter` и он расширил на все `40G`, а скриншот не сделался или я его не сделал)
